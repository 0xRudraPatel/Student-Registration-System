...
def registration_no():
    ...
    try:
        Registartion_number.set(int(max_row_value)+1)
    
    except:
        Registartion_number.set(1)
...
Label(root, text="Registration No:", bg=background_color, fg=frame_bg, font=("arial", 13)).place(x=30, y=150)
Label(root, text="Date:", bg=background_color, fg=frame_bg, font=("arial", 13)).place(x=500, y=150)

Registartion_number = IntVar()
Date = StringVar()

reg_entry = Entry(root, textvariable=Registartion_number, width=15, font=("arial", 10))
